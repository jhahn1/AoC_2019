...
const amplificationCircuitPart1 = require('./amplification-circuitPart1');
const amplificationCircuitPart2 = require('./amplification-circuitPart2');
...
describe('Day 7: Amplification Circuit', () => {
    ...
    it('should pass test 1 Part 2', () => {
        ...
        assert.equal(amplificationCircuitPart2(input, phaseSettingSequence), 139629729);
    });
});